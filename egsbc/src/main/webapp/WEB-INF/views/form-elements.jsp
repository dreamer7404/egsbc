	...
	<body class="">
		...
		<header id="header">
			<div id="logo-group">
				...
				<!-- AJAX-DROPDOWN : control this dropdown height, look and feel from the LESS variable file --><label class="toggle">
				...
				<ul class="header-dropdown-list hidden-xs">
					<li>
						...
						<ul class="dropdown-menu pull-right">
							...
							<li>
								<a href="javascript:void(0);"><img src="img/blank.gif" class="flag flag-jp" alt="Japan"> æ¥æ¬èª</a>
							</li>
							<li>
							...
							<li>
								<a href="javascript:void(0);"><img src="img/blank.gif" class="flag flag-ru" alt="Russia"> Ð ÑÑÑÐºÐ¸Ð¹ ÑÐ·ÑÐº</a>
							</li>
							<li>
								<a href="javascript:void(0);"><img src="img/blank.gif" class="flag flag-kr" alt="Korea"> íêµ­ì´</a>
							</li>						
		...
		<script data-pace-options='{ "restartOnRequestAfter": true }' src="/reources/js/plugin/pace/pace.min.js"></script>

		<!-- Link to Google CDN's jQuery + jQueryUI; fall back to local -->
		<script src="http://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
		<script>
			if (!window.jQuery) {
				document.write('<script src="/reources/js/libs/jquery-2.1.1.min.js"><\/script>');
			}
		</script>
		...
		<script>
			if (!window.jQuery.ui) {
				document.write('<script src="/reources/js/libs/jquery-ui-1.10.3.min.js"><\/script>');
			}
		</script>

		<!-- IMPORTANT: APP CONFIG -->
<!-- 		<script src="/reources/js/app.config.js"></script> -->

		<!-- JS TOUCH : include this plugin for mobile drag / drop touch events-->
<!-- 		<script src="/reources/js/plugin/jquery-touch/jquery.ui.touch-punch.min.js"></script>  -->

		<!-- BOOTSTRAP JS -->
<!-- 		<script src="/reources/js/bootstrap/bootstrap.min.js"></script> -->

		<!-- CUSTOM NOTIFICATION -->
<!-- 		<script src="/reources/js/notification/SmartNotification.min.js"></script> -->

		<!-- JARVIS WIDGETS -->
<!-- 		<script src="/reources/js/smartwidgets/jarvis.widget.min.js"></script> -->

		<!-- EASY PIE CHARTS -->
<!-- 		<script src="/reources/js/plugin/easy-pie-chart/jquery.easy-pie-chart.min.js"></script> -->

		<!-- SPARKLINES -->
<!-- 		<script src="/reources/js/plugin/sparkline/jquery.sparkline.min.js"></script> -->

		<!-- JQUERY VALIDATE -->
<!-- 		<script src="/reources/js/plugin/jquery-validate/jquery.validate.min.js"></script> -->

		<!-- JQUERY MASKED INPUT -->
<!-- 		<script src="/reources/js/plugin/masked-input/jquery.maskedinput.min.js"></script> -->

		<!-- JQUERY SELECT2 INPUT -->
<!-- 		<script src="/reources/js/plugin/select2/select2.min.js"></script> -->

		<!-- JQUERY UI + Bootstrap Slider -->
<!-- 		<script src="/reources/js/plugin/bootstrap-slider/bootstrap-slider.min.js"></script> -->

		<!-- browser msie issue fix -->
<!-- 		<script src="/reources/js/plugin/msie-fix/jquery.mb.browser.min.js"></script> -->

		<!-- FastClick: For mobile devices -->
<!-- 		<script src="/reources/js/plugin/fastclick/fastclick.min.js"></script> -->
